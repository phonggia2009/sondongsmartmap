...
const TOUR_STEPS: TourStep[] = [
  {
    ...
    description:
      'Khám phá không gian số Xã Sơn Đồng với dữ liệu địa lý chính xác, thông tin thôn xã, danh sách trường học và số liệu thống kê chi tiết.',
    icon: Sparkles,
    badge: 'Chào mừng',
    placement: 'center',
    features: [
      'Bản đồ ranh giới hành chính các thôn',
      'Tra cứu vị trí các trường học trên địa bàn',
      'Thống kê diện tích, dân số và văn hóa',
  ...
  },
  {
    ...
    description:
      'Sử dụng thanh công cụ bên trái để tìm kiếm nhanh theo tên thôn hoặc trường học. Bạn có thể chuyển đổi giữa danh sách Thôn xã và Trường học tại menu thả xuống.',
    targetSelector: '[data-tour="sidebar"]',
    icon: Search,
    badge: 'Bước 1 / 4',
    placement: 'right',
    features: [
      'Gõ từ khóa để lọc danh sách theo thời gian thực',
      'Chuyển đổi linh hoạt giữa danh sách Thôn và Trường',
      'Click vào từng thẻ để phóng to đến khu vực trên bản đồ',
    ],
  },
  {
    id: 'map-controls',
    title: 'Thao tác trên Bản đồ',
    description:
      'Bạn có thể di chuyển (pan), phóng to (zoom) hoặc click trực tiếp vào vùng ranh giới thôn và các marker trường học để xem chi tiết.',
    targetSelector: '[data-tour="map-toolbar"]',
    icon: Compass,
    badge: 'Bước 2 / 4',
    placement: 'top',
    features: [
      'Dùng công cụ góc dưới bên phải hoặc cuộn chuột để phóng to/thu nhỏ',
      'Nút đặt lại (Reset) để trở về góc nhìn toàn cảnh Sơn Đồng',
      'Nhấp vào vùng thôn để hiển thị viền ranh giới nổi bật',
    ],
  },
  {
    id: 'info-panel',
    ...
    description:
      'Khi chọn một thôn hoặc trường học, Bảng thông tin sẽ xuất hiện hiển thị thông tin giới thiệu, diện tích, dân số, các công trình nổi bật và hình ảnh.',
    icon: Info,
    badge: 'Bước 3 / 4',
    placement: 'center',
    features: [
      'Hiển thị thông số tổng quan & đặc điểm nổi bật',
  ...
  },
  {
    ...
    description:
      'Tùy chỉnh trải nghiệm của bạn với nút đổi Chế độ Sáng/Tối, Bật toàn màn hình. Bạn có thể bấm lại nút "Hướng dẫn" bất cứ lúc nào để xem lại tour này.',
